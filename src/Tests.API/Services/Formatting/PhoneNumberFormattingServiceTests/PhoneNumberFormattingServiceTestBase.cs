...
{
    public abstract class PhoneNumberFormattingServiceTestBase
    {
        protected PhoneNumberFormattingService Sut;
        protected readonly Mock<IPhoneNumberFormatsStore> FormatStoreMock;
        protected readonly Mock<ILogger<PhoneNumberFormattingService>> LoggerMock;

        protected PhoneNumberFormattingServiceTestBase()
        {
            FormatStoreMock = new Mock<IPhoneNumberFormatsStore>();
            LoggerMock = new Mock<ILogger<PhoneNumberFormattingService>>();

            SetupFormatStoreMock();

            Sut = new PhoneNumberFormattingService(FormatStoreMock.Object, LoggerMock.Object);
        }

        protected virtual void SetupFormatStoreMock()
        {
            FormatStoreMock
